...
over HTTP and WebSocket endpoints, compatible with EnvClient, and
mounts the Gradio web interface at the root path.
...
# Create the base OpenEnv API app
...
# Mount the custom Gradio UI at root to avoid /web routing issues on Spaces
